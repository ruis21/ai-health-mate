...
gsap.set(".merit .img", { zIndex: (i, target, targets) => targets.length - i });

var images = gsap.utils.toArray('.merit .img:not(.card05-txt)');
...
gsap.set(".merit.text", { zIndex: (i, target, targets) => targets.length - i });

var texts = gsap.utils.toArray('.merit .text');
